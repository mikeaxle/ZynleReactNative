...
import base64 from 'base-64'; //import encode base 64
...
class LoginForm extends Component {
    ...
    //function to authenticate and navigate to next screen
    checkLogin(){
...
export default connect(null, { moveToScreen })(LoginForm);